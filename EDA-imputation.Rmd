...
############ caseloads
ggplot(nat_dat,
       aes(x=year, y=cl/child_pop*1000))+
  geom_line()+
  facet_wrap(~HISORGIN)
...
ggplot(state_dat%>%
       ...
       aes(x=year, y=sqrt(cl/child_pop*1000)))+
  geom_line()+
  ggtitle("latino caseloads")+
  facet_wrap(~stname)
#########first entries
ggplot(nat_dat,
       aes(x=year, y=entries_first/child_pop*1000))+
  geom_line()+
  facet_wrap(~HISORGIN)

ggplot(state_dat%>%
         filter(HISORGIN=="hispanic"),
       aes(x=year, y=sqrt(entries_first/child_pop*1000)))+
  geom_line()+
  ggtitle("latino caseloads")+
  facet_wrap(~stname)
###########non-abuse first entries
ggplot(nat_dat,
       aes(x=year, y=entries_first_nonab/child_pop*1000))+
  geom_line()+
  facet_wrap(~HISORGIN)

ggplot(state_dat%>%
         filter(HISORGIN=="hispanic"),
       aes(x=year, y=sqrt(entries_first_nonab/child_pop*1000)))+
  geom_line()+
  ggtitle("latino caseloads")+
  facet_wrap(~stname)
####################reun exits
ggplot(nat_dat,
       aes(x=year, y=reun_exit/cl))+
  geom_line()+
  facet_wrap(~HISORGIN)

ggplot(state_dat%>%
         filter(HISORGIN=="hispanic"),
       aes(x=year, y=sqrt(reun_exit/cl)))+
  geom_line()+
  ggtitle("latino caseloads")+
  facet_wrap(~stname)
#####################law enf reports
ggplot(nat_dat,
       aes(x=year, y=report_source_law_enf/child_pop*1000))+
  geom_line()+
  facet_wrap(~HISORGIN)

ggplot(state_dat%>%
         filter(HISORGIN=="hispanic"),
       aes(x=year, y=sqrt(report_source_law_enf/child_pop*1000)))+
  geom_line()+
  ggtitle("latino caseloads")+
  facet_wrap(~stname)
##################comm reports
ggplot(nat_dat,
       aes(x=year, y=report_source_community/child_pop*1000))+
  geom_line()+
  ylim(0.0001, 10)+
  facet_wrap(~HISORGIN)
...
ggplot(state_dat%>%
         filter(HISORGIN=="hispanic"),
       aes(x=year, y=sqrt(report_source_community/child_pop*1000)))+
  geom_line()+
  ggtitle("latino caseloads")+
  facet_wrap(~stname)
############# total reports
...
ggplot(state_dat%>%
         filter(HISORGIN=="hispanic"),
       aes(x=year, y=sqrt((report_source_law_enf + 
